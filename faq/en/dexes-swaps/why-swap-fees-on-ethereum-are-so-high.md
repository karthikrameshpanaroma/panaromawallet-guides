...
It should also be noted that the recommended transaction fee shown by Panaroma Decentralized is the maximum expected fee for the transaction. The fees are estimated and not actual amounts.
